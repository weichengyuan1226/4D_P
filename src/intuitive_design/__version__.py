__title__ = 'intuitive_robotic_fabrication'
__description__ = 'intuitive robotic fabrication and design workflow using real time sensing and communication'
__url__ = 'https://github.com/gramaziokohler/intuitive_robotic_fabrication'
__version__ = '0.1.0'
